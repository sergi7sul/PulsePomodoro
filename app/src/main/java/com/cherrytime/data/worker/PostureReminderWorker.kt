...
@HiltWorker
class PostureReminderWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        val notification = notificationHelper.buildReminderNotification(
            message = applicationContext.getString(
                com.cherrytime.R.string.notification_posture_text
            ),
            openAppIntent = openIntent,
        )
        applicationContext.getSystemService(NotificationManager::class.java)
            .notify(NotificationHelper.NOTIFICATION_ID_POSTURE, notification)
        return Result.success()
    }

    companion object {
        const val WORK_NAME = "posture_reminder"
    }
}
